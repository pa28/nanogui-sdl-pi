...
/**
 * \class FramelessWindow frameless.h sdl_gui/frameless.h
 *
 * \brief Top-level, full screen, undecorated window widget.
 */
class  FramelessWindow : public Widget
{
    friend class Popup;
public:
    FramelessWindow(Widget *parent /*, const std::string &title = "Untitled"*/);
    FramelessWindow(Widget *parent /*, const std::string &title*/, const Vector2i& pos)
      : FramelessWindow(parent /*, title*/) { setPosition(pos); }
